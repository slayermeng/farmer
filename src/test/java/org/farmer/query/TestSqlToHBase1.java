 ...
 */
public class TestSqlToHBase1 {
    // CommanderDispatcher parser = new CommanderDispatcher();
    static long a=1,b=2,c=3,d=4,e=4,f=6,g=7;
    @Test
    ...
    public void parser() throws Exception{
        ...
        Select select = (Select)parserManager.parse(new StringReader("select * from test where a=3 or b=2 and c=3 and d=4 and e=5 or f=7"));
    ...
    public static boolean cal(BinaryExpression expression){
